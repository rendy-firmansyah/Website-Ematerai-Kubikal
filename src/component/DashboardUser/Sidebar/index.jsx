          ...
          <ul className="mb-6 flex flex-col gap-1.5 pl-0">
            <li>
              <NavLink
                to="/dashboard-user"
                className={({ isActive }) =>
                  "group relative flex items-center gap-2.5 rounded-sm p-2 font-medium text-[#DEE4EE] duration-300 ease-in-out hover:bg-[#cbd6fa] hover:text-slate-500 no-underline " +
                  (isActive && "bg-[#cbd6fa] text-slate-500")
                }
              >
                <svg
            ...
            <LinkGroup activeCondition={pathname.includes("riwayat")}>
              {(handleClick, open) => {
                return (
                  <>
                    <NavLink
                      to={"#"}
                      className={`group cursor-pointer relative flex items-center gap-2.5 rounded-sm p-2 font-medium text-[#DEE4EE] duration-300 ease-in-out hover:bg-[#cbd6fa] hover:text-slate-500 no-underline ${
                    ...
                    >
                      <ul className="mt-1 mb-5 flex flex-col gap-2.5 pl-4">
                        <li>
                          <NavLink
                            to="/riwayat/riwayat-pembubutan"
                            className={({ isActive }) =>
            ...
            <li>
              ...
              >
                ...
                >
                  ...
                  />
                  <path
                    d="M9 10C6.23858 10 4 12.2386 4 15C4 15.5523 4.44772 16 5 16H13C13.5523 16 14 15.5523 14 15C14 12.2386 11.7614 10 9 10Z"
                    fill=""
                  />
                </svg>
                Pengaturan
